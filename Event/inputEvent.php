...
<div class="main">
    <div class="wrapper">
        <form action="postEvent.php" method="post" enctype="multipart/form-data">
            <h1>Post Event</h1>
            <div class="input-box">
                <input type="file" required name="poster1">
            </div>
            <div class="input-box">
            ...
            <div class="input-box">
                <input type="text" placeholder="Description" required name="desc" class = 'apalah'>
            </div>
            <div class="input-box">
                <input type="text" placeholder="Ticket Link" required name="ticket">
            </div>
