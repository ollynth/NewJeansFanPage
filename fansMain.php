        ...
        <section class="banner-container">
            <div class="banner">
				...
				<button class="button prev">&#8676;</button>
                    <div class="content">
                        <iframe src="https://www.youtube.com/embed/8pMReO11Ln8?si=K5ybDyEEZNmY6tDG" name="player" id="iFrame"> </iframe>
					</div>
                </div>
            </div>
			...
			<div class="slide-text">
				<p>Dive deep into the world of denim magic with NewJeans in the exclusive behind-the-scenes of the [Light Jeans] LEVI'S® 501 CUSTOMIZATION Hero Campaign! 🧢✨ Ever wondered how iconic denim pieces come to life? Join NewJeans on a journey behind the curtain as they unveil the secrets, creativity, and passion that fuel the LEVI'S® 501 CUSTOMIZATION Hero Campaign. 👖</p>
			</div>
	    </section>
